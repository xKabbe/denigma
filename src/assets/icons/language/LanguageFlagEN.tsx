...
interface LanguageFlagENProps {
  size?: number;
}

function LanguageFlagEN({ size }: LanguageFlagENProps) {
  // Get flag svg from 'https://hatscripts.github.io/circle-flags/flags/us.svg'
  return (
...
// Default props
LanguageFlagEN.defaultProps = { size: 18 };

export default LanguageFlagEN;
